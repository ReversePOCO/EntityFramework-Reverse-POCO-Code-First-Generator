...
namespace V8EfrpgTest
{
    ...
    public class dcg_RovColumnDefinitionConfiguration : IEntityTypeConfiguration<dcg_RovColumnDefinition>
    {
        public void Configure(EntityTypeBuilder<dcg_RovColumnDefinition> builder)
        {
            ...
            builder.Property(x => x.Type).HasColumnName(@"TYPE").HasColumnType("char(2)").HasConversion(new ValueConverter<string?, string?>(v => v == null ? null : v.TrimEnd(), v => v == null ? null : v.TrimEnd())).IsRequired(false).IsFixedLength().IsUnicode(false).HasMaxLength(2);
        }
    }
